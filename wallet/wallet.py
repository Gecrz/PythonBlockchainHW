...
mnemonic = os.getenv("MNEMONIC", "mnemonic = core clown gloom easily unit usage tide doll rack patient loud scout hammer drum post")

#Create the derive function that takes all these arguments
...
#Create another function with coint and priv_key arguments. 
...
#create a creat tx function that contains all metada needed to transact. 
def create_tx(coin, account, to, amount):
    if coin == ETH:
        value = w3.toWei(amount, "ether") # convert 0.1 ETH to 120000000000 wei
...
#Create a send transaction function to call the previous function. 
